...
- Research synthesis behind these techniques: bdigital.media tech blog `/blog/condense-tech-writing` (companion post)
- Voice rules for the diff log itself: SOUL.md voice constitution (no em dashes, no "matters", no hedging in the meta-language of the skill itself)
