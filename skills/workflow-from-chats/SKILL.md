...
> **Attribution:** Ported from [`cursor-team-kit/skills/workflow-from-chats`](https://github.com/cursor/plugins/blob/3347cbab5b54136f6fba0994c3a01a56f7fb7fca/cursor-team-kit/skills/workflow-from-chats/SKILL.md) by Team Cursor, MIT-licensed. Adapted to Claude Code primitives by bdigital media. The only port change is "Cursor chats" → "Claude Code chats" in the description, since the source artifact differs by host. See [`PORTING-NOTES.md`](../../PORTING-NOTES.md).
